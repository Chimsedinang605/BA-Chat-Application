...
public class ClientFrame extends javax.swing.JFrame {
    ...
    public ClientFrame(LoginFrame loginFrm) {
        ...
        try {
            ...
            // Sử dụng HTML để chèn xuống dòng và căn giữa văn bản
            lbl_userName.setText("<html><div style='text-align: center;'>Welcome " + userName + "<br>Hãy chọn người bạn muốn chat</div></html>");
        } catch (Exception e) {
            closeEveryThing();
        }
    ...
    private void initComponents() {
        ...
        tbl_listOnline.setBackground(new java.awt.Color(255, 204, 204));
        ...
        tbl_listOnline.setSelectionBackground(new java.awt.Color(255, 204, 204));
        tbl_listOnline.setSelectionForeground(new java.awt.Color(255, 204, 204));
        ...
        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 180, 440, 240));

        lbl_userName.setFont(new java.awt.Font("Times New Roman", 2, 20)); // NOI18N
        lbl_userName.setForeground(new java.awt.Color(0, 0, 0));
        lbl_userName.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        getContentPane().add(lbl_userName, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 30, 270, 110));

        jLabel1.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        jLabel1.setForeground(new java.awt.Color(0, 0, 0));
        jLabel1.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/Remove-bg.ai_1715704472375.png"))); // NOI18N
        ...
        getContentPane().add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, -120, 710, 730));
        getContentPane().add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, -1, -1));

        lbl_userName1.setFont(new java.awt.Font("Times New Roman", 2, 20)); // NOI18N
        lbl_userName1.setForeground(new java.awt.Color(0, 0, 0));
        lbl_userName1.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        getContentPane().add(lbl_userName1, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 10, 270, 50));
