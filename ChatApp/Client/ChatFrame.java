...
public class ChatFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(lbl_recipient, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 20, 370, 50));

        jLabel1.setFont(new java.awt.Font("Tahoma", 0, 12)); // NOI18N
        jLabel1.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        getContentPane().add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 60, 180, 30));

        txp_dialogue.setBackground(new java.awt.Color(255, 204, 204));
        txp_dialogue.setFont(new java.awt.Font("Times New Roman", 2, 14)); // NOI18N
        ...
        txt_message.setBackground(new java.awt.Color(255, 204, 204));
        ...
        getContentPane().add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, -130, 780, -1));
