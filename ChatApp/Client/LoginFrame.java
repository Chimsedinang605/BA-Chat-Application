...
public class LoginFrame extends javax.swing.JFrame {
    ...
    public LoginFrame() {
        try {
            socket = new Socket("192.168.1.11", 6666);
            if (socket != null) {
                isConnected = true;
                connect();
            }
    ...
    public void processFeedback(String feedback) {
        ...
        if (feedback.startsWith("Dialogue")) {
            int x = 3;
            while (x-- > 0) {
                clientFrame.loadMessage(feedback);
            }
        }
...
//                String password = txt_passWord.getText();
                String encryptedPassword = encryptPassword(String.valueOf(txt_passWord.getPassword()));
                String infor = txt_userName.getText() + " " + encryptedPassword;
